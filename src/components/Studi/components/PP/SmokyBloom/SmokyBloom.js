...
import { BlendFunction, KernelSize, SRGBColorSpace } from "postprocessing";
import { KawaseBlurPass, LuminancePass, MipmapBlurPass } from "postprocessing";
import { getOutputColorSpace, setTextureColorSpace } from "../index";
...
export class SmokyBloom extends Effect {
  /**
  ...
  constructor({
    ...
    this.uniforms.get("map").value = mipmapBlur
