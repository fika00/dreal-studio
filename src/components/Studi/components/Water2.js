...
class Water extends Mesh {
  constructor(geometry, options = {}) {
    ...
    const normalMap0 =
      options.normalMap0 ||
      textureLoader.load("imgs/studi/Water_1_M_Normal.jpg");
    const normalMap1 =
      options.normalMap1 ||
      textureLoader.load("imgs/studi/Water_2_M_Normal.jpg");
...
Water.WaterShader = {
  ...
  fragmentShader: /* glsl */ `
		...
		void main() {
			...
			// gl_FragColor = vec4(vec3(( color, 1.0 ) * mix( refractColor, reflectColor, reflectance ) )+ vec3(0.047,0.29,0.412) * smoothstep(.35,.5,vUv.y),1.);
